...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.exportSortBox.setItemText(2, QCoreApplication.translate("MainWindow", u"Sorting: Light Type (Descending)",
                                                                     None))
        self.exportSortBox.setItemText(3, QCoreApplication.translate("MainWindow", u"Sorting: Light Type (Ascending)",
                                                                     None))
        self.exportSortBox.setItemText(4, QCoreApplication.translate("MainWindow", u"Only Show: Ambient Lights", None))
        self.exportSortBox.setItemText(5,
                                       QCoreApplication.translate("MainWindow", u"Only Show: Directional Light", None))
        ...
        self.importSortBox.setItemText(2, QCoreApplication.translate("MainWindow", u"Sorting: Light Type (Descending)",
                                                                     None))
        self.importSortBox.setItemText(3, QCoreApplication.translate("MainWindow", u"Sorting: Light Type (Ascending)",
                                                                     None))
        self.importSortBox.setItemText(4, QCoreApplication.translate("MainWindow", u"Only Show: Ambient Lights", None))
        self.importSortBox.setItemText(5,
                                       QCoreApplication.translate("MainWindow", u"Only Show: Directional Light", None))
